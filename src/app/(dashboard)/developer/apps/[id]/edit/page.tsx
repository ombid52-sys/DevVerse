...
export default function EditApplicationPage({
  ...
  if (loading) {
    return <div className="p-8 text-center text-xs text-neutral-400">Loading application...</div>;
  }
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="space-y-2 pb-6 border-b border-neutral-200">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href={`/developer/apps/${id}/source`}>
      ...
      {success && (
        <div className="p-3 bg-emerald-50 border border-emerald-200 text-xs text-emerald-700 font-medium rounded-md flex items-center gap-1.5">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 sm:p-8 rounded-xl border border-neutral-200 shadow-sm">
        <div className="space-y-4">
          ...
          <Input
            ...
            helperText="Changing slug will update the public URL"
          />
        ...
        <div className="pt-4 border-t border-neutral-100 space-y-4">
          ...
          <Input
            label="Live Runtime / Web App URL"
            type="url"
            value={runtimeUrl}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="block text-[11px] text-neutral-500 mt-0.5">
                Visible to all platform visitors
              </span>
            </label>
            ...
            >
              ...
              <span className="block text-[11px] text-neutral-500 mt-0.5">
                Accessible only to you and admins
              </span>
            </label>
          </div>
        </div>
